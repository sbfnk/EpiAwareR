...
# Use tspan = (45, 80) to match the preprint exactly
# This corresponds to Feb 13 - Mar 19, 2020 (the main epidemic wave)
training_data <- data.frame(
  date = south_korea$date[45:80],
  y_t = south_korea$cases_new[45:80]
)
...
plot(training_data$date, training_data$y_t, type = "b",
...
model <- EpiProblem(
  ...
  tspan = c(1, 36) # 36 days matching preprint's tspan=(45,80) window
)
