...
**EpiAwareR** is an R interface to the Julia-based [EpiAware](https://github.com/CDCgov/Rt-without-renewal) compositional infectious disease modelling framework. It enables R users to build flexible epidemiological models by composing reusable components without requiring Julia expertise.
...
On first use, EpiAwareR will attempt to automatically install Julia and required packages. If this fails, run:
...
Here's a basic example replicating Mishra et al. (2020) analysis of COVID-19 in South Korea:
...
EpiAwareR is currently in MVP (Minimum Viable Product) phase, implementing core components needed for the Mishra et al. (2020) case study. 
